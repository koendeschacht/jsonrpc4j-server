...
import com.github.koendeschacht.jsonrpc4j.StreamServer;
...
import static com.github.koendeschacht.jsonrpc4j.util.Util.DEFAULT_LOCAL_HOSTNAME;
...
public class StreamServerTest {
	...
	public void testClientDisconnectsCausingExceptionOnServer() throws Exception {
		...
		StreamServer.Server server = streamServer.getServers().iterator().next();

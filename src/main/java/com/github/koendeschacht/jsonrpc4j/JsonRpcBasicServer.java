...
import com.github.koendeschacht.jsonrpc4j.ErrorResolver.JsonError;
...
import static com.github.koendeschacht.jsonrpc4j.ReflectionUtil.getParameterTypes;
import static com.github.koendeschacht.jsonrpc4j.Util.hasNonNullData;
import static com.github.koendeschacht.jsonrpc4j.ErrorResolver.JsonError.ERROR_NOT_HANDLED;
import static com.github.koendeschacht.jsonrpc4j.ReflectionUtil.findCandidateMethods;
...
public class JsonRpcBasicServer {
    ...
    private Object invokePrimitiveVarargs(Object target, Method method, List<JsonNode> params, Class<?> componentType) throws IllegalAccessException, InvocationTargetException {
        ...
        for (int i = 0; i < params.size(); i++) {
            Object object = getObject(method, params, i);
    ...
    private Object getObject(Method method, List<JsonNode> params, int i) {
